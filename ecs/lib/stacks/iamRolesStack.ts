...
export class IamRolesStack extends Stack {
    private readonly ECS_TASK_ROLE_NAME = 'ecs-pet-clinic-task-role-v2';
    private readonly ECS_TASK_EXECUTION_ROLE_NAME = 'ecs-pet-clinic-task-execution-role-v2';
    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        this.ecsTaskRole = new Role(this, 'EcsTaskRoleV2', {
        ...
        this.ecsTaskExecutionRole = new Role(this, 'EcsTaskExecutionRoleV2', {
